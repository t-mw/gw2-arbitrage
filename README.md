...
1. Run the `gw2-arbitrage` binary using the terminal application (i.e. run `gw2-arbitrage.exe` from Powershell on Windows) to produce a list of items that can be crafted and immediately resold
